...
const MODES = [
  {
    ...
    description: "Lật thẻ từ vựng: tự đánh giá mặt trước ↔ mặt sau.",
    icon: <Layers size={22} />,
    color: BRAND.blue,
    minCards: 1,
  },
  {
    ...
    description: "Chọn đáp án tiếng Việt chính xác trong 4 phương án.",
  ...
  },
  {
    ...
    description: "Nối nhanh từ vựng với ý nghĩa tương ứng.",
  ...
  },
  {
    ...
    description: "Nhìn nghĩa tiếng Việt và tự gõ chính xác từ vựng.",
    icon: <Edit3 size={22} />,
    color: BRAND.yellow,
    minCards: 1,
  },
        ...
        <>
          <div className="mt-4 mb-6">
            ...
            <p className="mt-1.5 text-xs text-muted-foreground">
              Tổng cộng <strong className="text-foreground">{lesson.vocabulary.length} từ vựng</strong> trong bài học này:
            </p>
          </div>
                    ...
                    <div className="flex items-center gap-4 rounded-3xl border border-dashed border-border bg-card/40 p-4 opacity-60">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-xs text-muted-foreground">
                          Cần tối thiểu {m.minCards} từ để mở chế độ này.
                        </p>
                      </div>
                    </div>
                  )}
